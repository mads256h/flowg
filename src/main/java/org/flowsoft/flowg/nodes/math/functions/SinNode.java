...
public class SinNode extends UnaryNode<ActualParameterListNode> implements ExpressionNode {
    public SinNode(ActualParameterListNode actualParameterListNode, Location left, Location right) {
